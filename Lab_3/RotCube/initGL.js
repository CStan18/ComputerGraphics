...
var leftorbit = false; // this and determines which direction it is turning (if it's false, it's assumed to be turning right)
...
function initGL() {
    ...
    projection = mult(projection, lookAt(vec3(-10, -10, -10), vec3(10, 10, 10), vec3(0, 20, 0)));
